...
# Critical Warning
The current stable version, 1.1-final, released in 2004, suffers from critical security vunerabilities, which would allow the IRC server to execute arbitrary code on the user's machine.  (CVE-2007-3360, CVE-2007-4584). The stable version of BitchX should not be used until a new version
is released.
