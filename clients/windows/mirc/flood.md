...
When you're using [mIRC](/clients/windows/mirc/) there are several ways to get rid of
...
[upgrade](/clients/windows/mirc/index.html#download-mirc) if you're using an older version.
