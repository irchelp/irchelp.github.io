...
If this page doesn't answer all your questions, go to the official 
**[mIRC home page](http://www.mirc.com/)** [ext. link] 
which contains a wealth of information on mIRC: getting it, setting it up,
using it, etc.
...
[hybrid-6 ircd](/ircd/hybrid/hybrid6.html) as well as some other networks
such as DALnet. Fix it with this replacement Onotice.mrc
{% comment %}
[Onotice.mrc](Onotice.mrc)
{% endcomment %}
